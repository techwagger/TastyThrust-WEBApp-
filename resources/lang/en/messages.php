<?php return array (
  ...
  'GST_No.' => 'GST No.',
  'cdfghgj' => 'Cdfghgj',
  'Delivery Partner start message' => 'Delivery Partner start message',
  'Banner' => 'Banner',
  'Pending Delivery_Partner' => 'Pending Delivery Partner',
  'denied' => 'Denied',
  'Customer notify message for delivery partner' => 'Customer notify message for delivery partner',
  'Denied Delivery Partner' => 'Denied Delivery Partner',
  'Attribute added successfully!' => 'Attribute added successfully!',
  'Soyabean Oil' => 'Soyabean Oil',
  'Pending Delivery Partner' => 'Pending Delivery Partner',
  'delivery partner assign message' => 'Delivery partner assign message',
  'vendors' => 'Vendors',
  'Order manager' => 'Order manager',
  'POS manager' => 'POS manager',
  'return_purchase_ingredient_items' => 'Return purchase ingredient items',
  'Orange' => 'Orange',
  ' must not be empty.' => ' must not be empty.',
  'recipie_ingredient' => 'Recipie ingredient',
  'Send_Mail_on_Forgot_Password' => 'Send Mail on Forgot Password',
  'If_enabled,_Delivery_Partner_will_receive_an_automated_mail_from_the_system_when_their_registration_is_successful.' => 'If enabled, Delivery Partner will receive an automated mail from the system when their registration is successful.',
  'If_disabled,_Delivery_Partner_will_not_get_a_registration_approval_email.' => 'If disabled, Delivery Partner will not get a registration approval email.',
  'If_disabled,_Delivery_Partner_will_not_receive_any_email_upon_rejection_for_registration.' => 'If disabled, Delivery Partner will not receive any email upon rejection for registration.',
  'New_Delivery_Partner_Registration' => 'New Delivery Partner Registration',
  'Email_Templateq' => 'Email Templateq',
  'Email_Templatesq' => 'Email Templatesq',
  ...
  'Product1' => 'Product1',
  'DASHBOARD' => 'DASHBOARD',
  'purchases_ingredient_items' => 'Purchases ingredient items',
  -99 => '-99',
  -88 => '-88',
  'rice test' => 'Rice test',
