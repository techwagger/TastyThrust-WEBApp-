            ...
            <div class="navbar-vertical-footer-offset">
                ...
                <div class="navbar-vertical-content text-capitalize">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('branch/table/order/list/*') || Request::is('branch/table/index')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle" href="javascript:">
                                <i class="tio-shopping-cart nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
...
{{--                                <label class="badge badge-danger">{{translate('addon')}}</label>--}}
                            ...
                            <ul class="js-navbar-vertical-aside-submenu nav nav-sub" style="display: {{Request::is('branch/table/order*')||Request::is('branch/table/index')?'block':'none'}}">
                                ...
                                <li class="nav-item {{Request::is('branch/table/index')?'active':''}}">
                                    <a class="nav-link " href="{{route('branch.table.index')}}" title="">
                                        <span class="tio-circle nav-indicator-icon"></span>
                                        <span class="text-truncate sidebar--badge-container">
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('branch/promotion/*')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('branch.promotion.create')}}">
                                <i class="tio-shopping-cart nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                    {{translate('table_promotion')}}
                                </span>
                            </a>
                        </li>
                        ...
                        <li class="navbar-vertical-aside-has-menu {{Request::is('branch/table/list')?'active':''}}">
                            <a class="js-navbar-vertical-aside-menu-link nav-link" href="{{route('branch.table.list')}}">
                                <i class="tio-shopping-cart nav-icon"></i>
                                <span class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
