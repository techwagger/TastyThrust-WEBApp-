                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$phone}}"
                                       name="phone" id="phone" class="form-control" onkeydown="validationPhone()" onkeyup="validateMobileNumber(this)" required placeholder="{{translate('Ex: +9xxx-xxx-xxxx')}}">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="email" value="{{$email}}"
                                       name="email" class="form-control" id="email" onkeyup="validationemail()" required placeholder="{{translate('Ex: contact@company.com')}}">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                name="gst_number" class="form-control" id="gst" placeholder="{{translate('GSTIN')}}">
...
{{--                            </div>--}}
            ...
            <div class="btn--container mt-4">
                ...
                <button type="{{env('APP_MODE')!='demo'?'submit':'button'}}" id="submit" onclick="{{env('APP_MODE')!='demo'?'':'call_demo()'}}" class="btn btn-primary">{{translate('submit')}}</button>
            </div>
        </form>
    </div>
@endsection
