                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" onkeyup="validateMobileNumber(this)" name="phone" value="{{$e['phone']}}" class="form-control" placeholder="Ex : 017********" required>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="email" value="{{$e['email']}}" name="email" class="form-control" id="email" onkeyup="validationemail()" placeholder="{{translate('Ex')}} : ex@gmail.com" required>
