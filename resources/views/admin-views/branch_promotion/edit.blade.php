                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="from_part_2 video_section" id="video_section">
                                    ...
                                    <input type="text" name="video" id="url" oninput="validateUrl()" value="{{$promotion->promotion_name}}" class="form-control" placeholder="{{ translate('ex : https://youtu.be/0sus46BflpU') }}" required>
